...
{/* New Layout Design */}
      ...
      <div className="w-1/3">
        ...
        <div className="font-thin  w-auto md:w-2/4 text-xl opacity-65 text-white">
          <p>No matter your digital service needs, I’ll work with you to define a strong visual identity. One that communicates your personality and vision through a visual cohesive story. Available for local and international projects.</p>
        </div>
      </div>
