...
function About() {
  return (
    <div id="about" className=" relative w-full h-auto  flex flex-col">
      ...
      <div className="w-full h-full flex flex-col md:flex-row justify-center items-center mt-64">
        <div className="max-w-3xl mx-auto h-auto md:px-5 gap-y-10 flex flex-col">
          <p className="text-titleMid smd:text-titleSmd smd:leading-[4rem] leading-[3rem] md:text-titleMd md:leading-[5rem] uppercase font-semibold opacity-75 text-neutral-default p-5">
            Crafting Unique Digital Experiences.
          </p>
          <div className="w-auto h-full bg-white py-10">
            <p className="tracking-wide text-xl lg:text-secTitle text-accent-default font-normal uppercase  p-5">
              <span className="bodyText capitalize italic font-bold">Hello!</span> I&apos;m Kenneth, the mind behind Debonair Fox Creative Studio. I
              believe that every story deserves to be told with elegance and
              creativity. With a background steeped in diverse creative pursuits,
              I have honed a keen eye for intriguing visuals and the subtleties of
              our environment.
            </p>
            <p className="tracking-wide text-xl lg:text-secTitle text-accent-default font-normal uppercase  p-5">
            This heightened awareness allows me to find beauty in the most
              unexpected places, transforming the ordinary into extraordinary. As
              a thoughtful creative, I&apos;m passionate about making impactful
              first impressions and bringing my clients unique narratives to life.</p>
          </div>
        </div>
